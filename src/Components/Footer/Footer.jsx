const Footer = () => {
  ...
  return (
    <footer className="pt-10 bg-[#2f3542]">
      <div className="p-5 md:px-32 px-5 mx-auto">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            ...
            >
              <div className="relative">
                <svg
                  className="w-6 h-6 text-white absolute left-3 inset-y-0 my-auto"
              ...
              <button className="text-white font-medium bg-sky-500 hover:bg-sky-400 active:bg-sky-600  px-4 py-2 rounded-md transition duration-300 ease-in-out">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
          {footerNavs.map((item, idx) => (
            <ul className="space-y-4 text-gray-300" key={idx}>
              <h4 className="text-[#ffdd00] font-semibold sm:pb-2">
                {item.label}
              </h4>
              {item.items.map((el, idx) => (
                <li key={idx}>
                  <a
                    href={el.href}
                    className="duration-150 hover:text-[#ffdd00]"
                  >
                    {el.name}
                  </a>
                </li>
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          <p className="text-gray-300">
            © 2024 Dark Tech Inc. All rights reserved.
          </p>
